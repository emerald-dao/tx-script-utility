    ...
    return (
        <div>
            ...
            <main>
                ...
                {!monacoReady && (
                    <p>Please wait, instantiating Monaco Editor...</p>
                )}
                ...
                {monacoReady && (
                    <>
                        <div className="mb-1">
                            ...
                            <p>
                                These are the addresses, which will be used,
                                before sending Cadence template to network:
                            </p>
                            <ul>
